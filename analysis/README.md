...
| D255 | Kit acquisizione Windows APP12509 | ultima run consumata: TShark vivo ma stop pre-attach sulla race pcapng; Goodix non collegato; readiness corretta offline, review/prova Windows/nuova autorizzazione pendenti | `analysis/D255/D255_windows_targeted_evidence_capture_kit_report.md` | `analysis/D255/D255_windows_targeted_evidence_capture_kit_bundle.zip` |
