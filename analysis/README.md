...
| D255 | Kit acquisizione Windows APP12509 | ramo live fallito pre-autorizzazione su array OEM vuoto; fix di classe READY per review AI-PM, simulazione Windows pendente, hardware non autorizzato | `analysis/D255/D255_windows_targeted_evidence_capture_kit_report.md` | `analysis/D255/D255_windows_targeted_evidence_capture_kit_bundle.zip` |
