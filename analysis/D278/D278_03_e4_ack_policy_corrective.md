...
POST_CORRECTIVE_TEST_RUNTIME=FREEDESKTOP_SDK_25_08
POST_CORRECTIVE_ARTIFACT_STORAGE=OPERATOR_FEDORA_HOST_TMP
...
### Verifica AI-PM dei log e host-native del launcher

L'Utente ha verificato localmente sul Fedora operatore l'esistenza del build e
del launcher candidate; l'AI-PM ha revisionato integralmente i due log locali e
li ha approvati. Il preciso launcher è stato poi eseguito nativamente sul
Fedora operatore solo con `--self-test`, con `ldd` che risolve le librerie host
e zero accesso USB.

```text
AI_PM_POST_CORRECTIVE_LOG_REVIEW=PASS
OPERATOR_LOCAL_ARTIFACT_VERIFICATION=PASS
LAUNCHER_SHA256_LOCAL_VERIFIED=bf7a1b0dae42d1c17b613c3f03338d10c3448be622e8bc46383f1923f56f192d
D278_02_LOG_REVIEW=PASS
FOCUSED_SECURE_SESSION_LOG_REVIEW=PASS
HOST_NATIVE_LAUNCHER_CHECK=PASS
HOST_NATIVE_LDD=PASS
HOST_NATIVE_SELF_TEST=PASS
HOST_NATIVE_SELF_TEST_RC=0
HOST_NATIVE_SELF_TEST_REAL_USB_ACCESS=0
