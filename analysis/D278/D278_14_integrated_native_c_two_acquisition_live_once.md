# D278/14 — consumed live failure and host-only FpDevice USB binding corrective

## Outcome

```text
OUTCOME=PASS_HOST_ONLY_CORRECTIVE
ADVANCEMENT=FPDEVICE_USB_BINDING_EXECUTABLE_CLOSURE_FIXED
EXECUTABLE_CLOSURE=PASS_HOST_ONLY
CANONICAL_DOCUMENTATION=UPDATED
```

This corrective performed no live execution. The only D278/14 live
authorization was already consumed by the failed attempt described below and
is not reusable.

```text
START_BRANCH=main
START_HEAD=2172e750ae7c100a3a891ba25d0797286230a4ab
...
| `run_goodix_d278_secure_session_test.sh` | 17/17 normal PASS; 17/17 ASAN/UBSAN PASS |
...
These no-live markers apply to the corrective execution, not to the consumed
