...
the opt-in selector's VM build/tests and installation passed. The next gate is
[password-first login, then opt-in fingerprint](../plasma-login-opt-in/R4_PLASMA_LOGIN_VM.md).
