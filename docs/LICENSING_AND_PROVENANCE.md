...
| `core/post_d4.py` (image codec) | local project | `bc377c820fa661c889d61b17a4c81e42507fc78a` | `src/goodix5125_cleanroom.py` | Historical local implementation; new GPL core expression `GPL-2.0-or-later` | Goodix 27c6:5125 project contributors | `D249` | `LOCAL_EXISTING_REUSED`: exact 7684-byte record, CRC-32/MPEG-2, packed-12 and target transpose; Rocky decoder was not substituted. |
