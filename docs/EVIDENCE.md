...
- **Source identifier/hash:** `gfusb.dll` SHA-256 `904eab...c7e2`; capture SHA-256 values listed in REFERENCES.
...
- **Source type:** non-redistributed OEM static source and private captures.
- **Source identifier/hash:** `gfusb.dll` SHA-256 `904eab...c7e2`; B0 writer address `0x180012660`.
...
- **Source identifier/hash:** `gfusb.dll` SHA-256 `904eab...c7e2`; runtime PSK publication area `0x180576e50`.
...
- **Source identifier/hash:** `gfusb.dll` SHA-256 `904eab...c7e2`; TLS suite identifier `0x00a8`.
...
- **Source identifier/hash:** SHA-256 `50071c0f...c184b` and `4ac611e0...a02a`.
...
- **Source identifier/hash:** exact wire above; builder in `gfusb.dll` SHA-256 `904eab...c7e2`.
...
- **Source identifier/hash:** APP SHA-256 `70d3befb...cb47`; receivers `0x08033568` and `0x080367d0`; flash control `0x0802d874`/`0x40023c00`.
...
- **Source identifier/hash:** exact request `a00600a6a203000114f0`; target APP SHA-256 `70d3befb...cb47`.
...
- **Source type:** non-redistributed target APP static analysis.
- **Source identifier/hash:** APP SHA-256 `70d3befb...cb47`; dispatch `0x08035eb0`; initializer sites `0x080342f0`, `0x0803456e`, `0x08034828`, `0x0803496e`.
...
- **Source identifier/hash:** decoder/CRC area `0x180024010..0x1800244d9`; `gfusb.dll` SHA-256 `904eab...c7e2`.
...
- **Claim:** offline framing, TLS boundaries, image decoding and lifecycle shapes are implementable clean-room; runtime device support is not ready.
- **Status:** STRONGLY_SUPPORTED
- **Evidence:** deterministic synthetic implementations and tests tied to the evidence above.
- **Source type:** project-authored clean-room code.
- **Source identifier/hash:** public tree manifest and synthetic test suite.
- **Independent cross-check:** no public code imports USB, embeds secrets or exposes firmware/provisioning operations.
- **Known falsifiers:** hidden private/OEM bytes, unbounded parsing, or an accidental hardware entrypoint.
- **Residual uncertainty:** target resident receivers, real TLS, images and libfprint policy.
