...
build=${D278_06_BUILD_DIR:-$(mktemp -d /tmp/goodix-d278-06.XXXXXX)}
inner="$script_dir/run_goodix_d278_06_precommand_observer_test_inner.sh"
host_gusb=
...
test -x "$build/d278_precommand_observe_once"
ldd "$build/d278_precommand_observe_once"
sha256sum "$build/d278_precommand_observe_once"
