...
build=${D278_02_BUILD_DIR:-$(mktemp -d /tmp/goodix-d278-02.XXXXXX)}
inner="$script_dir/run_goodix_d278_02_test_inner.sh"
host_gusb=
...
test -x "$build/d278_native_secure_session_once"
ldd "$build/d278_native_secure_session_once"
sha256sum "$build/d278_native_secure_session_once"
