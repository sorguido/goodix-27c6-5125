...
compile_libfprint "$local_fp_dir/fpi-image.c" "$build_dir/fpi-image.o"
...
# ---- Link ----
gcc $local_flags $glib_cflags $includes -c "$git_root/libfprint-driver/rockytkg-imgproc/goodix_imgproc.c" -o "$build_dir/r2.o"
gcc $strict_flags $glib_cflags $includes -c "$git_root/libfprint-driver/goodix_sigfm_preprocess.c" -o "$build_dir/preprocess.o"
g++ -std=c++17 -O2 -g $includes -c "$git_root/libfprint-driver/goodix_sigfm_metrics.cpp" -o "$build_dir/metrics.o"
gcc -Wl,--gc-sections "$build_dir/metrics.o" -lstdc++ \
  "$build_dir/fp-device.o" \
  "$build_dir/fpi-device.o" \
  "$build_dir/fp-image-device.o" \
  "$build_dir/fpi-image-device.o" \
  "$build_dir/fpi-image.o" "$build_dir/r2.o" "$build_dir/preprocess.o" \
...
compile_libfprint_san "$local_fp_dir/fpi-image.c" "$build_dir/fpi-image_san.o"
...
gcc $san_local_flags $glib_cflags $includes -c "$git_root/libfprint-driver/rockytkg-imgproc/goodix_imgproc.c" -o "$build_dir/r2_san.o"
gcc $san_strict_flags $glib_cflags $includes -c "$git_root/libfprint-driver/goodix_sigfm_preprocess.c" -o "$build_dir/preprocess_san.o"
g++ -std=c++17 $san_common $includes -c "$git_root/libfprint-driver/goodix_sigfm_metrics.cpp" -o "$build_dir/metrics_san.o"
gcc $san_common -Wl,--gc-sections "$build_dir/metrics_san.o" -lstdc++ \
  "$build_dir/fp-device_san.o" \
  "$build_dir/fpi-device_san.o" \
  "$build_dir/fp-image-device_san.o" \
  "$build_dir/fpi-image-device_san.o" \
  "$build_dir/fpi-image_san.o" "$build_dir/r2_san.o" "$build_dir/preprocess_san.o" \
