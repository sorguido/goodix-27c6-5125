...
offline_preflight () {
  ...
  echo D282_01_SYSTEMD_SELINUX_STAGING_CORRECTIVE=VERIFIED_PRIVILEGED_HOST
  echo D282_01_SELINUX_WRAPPER_FAILURE=RESOLVED
  echo FPRINTD_SYSTEMD_STAGING_START=VERIFIED_PRIVILEGED_HOST
  ...
  echo D282_01_PRIVILEGED_STAGING_PROBE=ACCEPTED_CLOSED
  echo D282_01_PRIVILEGED_STAGING_PROBE_RESULT=PASS
  echo D282_01_PRIVILEGED_STAGING_PROBE_EXECUTED=true
  echo D282_01_PRIVILEGED_STAGING_PROBE_WAS_AUTHORIZED=true
  echo D282_01_PRIVILEGED_STAGING_PROBE_CURRENTLY_AUTHORIZED=false
  echo D282_01_PRIVILEGED_STAGING_PROBE_GRANT_CONSUMED=true
  echo D282_01_PRIVILEGED_STAGING_PROBE_RETRY_AUTHORIZED=false
