...
Build, installation and [real VM login](../../../../deployment/plasma-login-opt-in/R4_PLASMA_LOGIN_VM.md) are completed PASS.
...
[R5 VM procedure](../../../../deployment/recovery/R5_VM.md). The component procedure below is historical.
...
The [completed login](../../../../deployment/plasma-login-opt-in/R4_PLASMA_LOGIN_VM.md) demonstrated functional authentication
