...
build=${D278_09_BUILD_DIR:-$(mktemp -d /tmp/goodix-d278-09.XXXXXX)}
inner="$script_dir/run_goodix_d278_09_a2_sensor_only_probe_test_inner.sh"
host_gusb=
...
test -x "$build/d278_a2_sensor_only_observe_once"
ldd "$build/d278_a2_sensor_only_observe_once"
sha256sum "$build/d278_a2_sensor_only_observe_once"
