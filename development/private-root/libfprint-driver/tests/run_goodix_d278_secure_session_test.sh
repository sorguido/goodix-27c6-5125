...
echo D280_01_PRODUCTION_SHAPED_ENROLL_CLOSE_OPEN_IDENTIFY=PASS
echo D280_01_PRODUCTION_OPEN_EPOCH_ACTION_MAX=1
echo D280_01_SUCCESSFUL_IDENTIFY_ACQUISITION_COUNT=1
echo D280_01_MISMATCH_IDENTIFY_ACQUISITION_COUNT=1
echo D280_01_IDENTIFY_REARM_COUNT=0
echo D280_01_PRODUCTION_SHAPED_SIGFM_IMPLEMENTATION=TEST_DOUBLE
echo D280_01_REAL_USB_ACCESS=0
...
echo D291_FIXED_RAW_PINNING_MECHANICS=PASS
echo D291_LOGICAL_OPEN_SIGFM_BASELINE_PINNING=IMPLEMENTED_NOT_VALIDATED
echo D291_BIOMETRIC_STABILITY=OPEN
...
echo D291_NO_HIDDEN_RETRY=true
echo D291_NO_FOURTH_VERIFY_FROM_MAX_TRIES_3=true
echo D291_FACTORY_PRESERVING_COMMAND_FAMILY_UNCHANGED=true
