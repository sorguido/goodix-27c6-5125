...
MODULE_PATH = Path(__file__).with_name("d279_42_protected_baseline_delta_eval.py")
SPEC = importlib.util.spec_from_file_location("d279_42_runner_tested", MODULE_PATH)
...
class ProtectedBaselineDeltaRunnerTests(unittest.TestCase):
    ...
    def test_operation_is_new_and_exact(self):
        ...
        self.assertNotIn("D279_39", RUNNER.OPERATION)
