...
sed -e "s|@PREFIX@|$runtime_dir|g" \
    ...
    "$snapshot_root/operator_kit/d279-44-offline-protected-halfwave-delta/pixman-1.pc.in" \
...
spec = importlib.util.spec_from_file_location("d279_44_build_check", sys.argv[1])
...
echo D279_44_EXACT_TARGET_LIBFPRINT=1.94.100
echo "D279_44_PINNED_PIXMAN=$pixman_version"
echo D279_44_EXACT_RESIZE=PIXMAN_BILINEAR_FACTORS_2_3
echo D279_44_FACTOR_1_CONTROL=D279_34_EXACT_NBIS_PATH
echo D279_44_NBIS_QUALITY_HELPER_BUILD=PASS
echo D279_44_PRODUCTION_USB_REACHED=false
