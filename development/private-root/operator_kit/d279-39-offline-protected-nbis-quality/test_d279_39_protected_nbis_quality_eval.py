...
MODULE_PATH = Path(__file__).with_name("d279_39_protected_nbis_quality_eval.py")
SPEC = importlib.util.spec_from_file_location("d279_39_runner_tested", MODULE_PATH)
...
class ProtectedNbisQualityRunnerTests(unittest.TestCase):
