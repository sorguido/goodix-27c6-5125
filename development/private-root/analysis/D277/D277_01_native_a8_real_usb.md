...
```text
D277_01_ORIGINAL_LIVE_BASELINE=95f40ca791011d637e2040a87014bbb8e946275e
D277_01_SECOND_CORRECTIVE_BASELINE=0472d1f0bade6f47954403ca942829c80243cd4b
D277_01_CORRECTIVE_VALIDATED_COMMIT=d9336c6e033d736a794dae3486ae84c33c412b01
D277_01_CANONICAL_CLOSURE_DOC_COMMIT=PENDING_USER_COMMIT
D277_01_GITHUB_ACTIONS_RUN=33207424835
D277_01_GITHUB_ACTIONS_RESULT=PASS
...
## Post-CI canonical closure

La GitHub Actions run `33207424835` sul commit
`d9336c6e033d736a794dae3486ae84c33c412b01` è `PASS`. Il job host-only ha
chiuso con successo:

```text
D276_04_DETERMINISTIC_NORMAL_AND_SANITIZER=PASS
D276_02_REGRESSION=PASS
D276_03_REGRESSION=PASS
D277_01_NORMAL=15/15_PASS
D277_01_ASAN_UBSAN=15/15_PASS
D277_01_LIVE_HARNESS_BUILD=PASS
...
D277/01 è quindi chiuso come correttivo host-only. La run fallita
`33206366417` resta nella provenance come motivazione del secondo correttivo.
Il confine nativo A8/A0 su target reale resta non provato; `LIVE_AUTHORIZED`
resta `false`.
...
OUTCOME=READY
ADVANCEMENT=CANONICAL_POST_CI_CLOSURE_OF_D277_01_HOST_ONLY_CORRECTIVE
EXECUTABLE_CLOSURE=PASS_HOST_ONLY
RESIDUAL_BLOCKER_OR_RISK=NATIVE_A8_A0_PATH_UNPROVEN;CURRENT_UNPRIVILEGED_OPERATOR_CONTEXT_LACKS_USB_NODE_WRITE_PERMISSION;NEW_EXPLICIT_LIVE_AUTHORIZATION_REQUIRED;GLOBAL_HARDWARE_EQUIVALENCE_UNPROVEN;PRODUCTION_DEVICE_QUIESCENCE_AFTER_ARBITRARY_CANCEL_UNRESOLVED
CANONICAL_DOCUMENTATION=UPDATED
REVIEW_SET=BASELINE_95f40ca791011d637e2040a87014bbb8e946275e_PLUS_SECOND_CORRECTIVE_BASELINE_0472d1f0bade6f47954403ca942829c80243cd4b_PLUS_VALIDATED_COMMIT_d9336c6e033d736a794dae3486ae84c33c412b01_PLUS_analysis/D277/D277_01_native_a8_real_usb.md_PLUS_analysis/D277/D277_01_native_a8_real_usb.json_PLUS_Goodix_27c6_5125_manuale_tecnico.md
