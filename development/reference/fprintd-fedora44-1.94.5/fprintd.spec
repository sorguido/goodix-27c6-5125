...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.5-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Dec 15 2025 Neal Gompa <ngompa@fedoraproject.org> - 1.94.5-4
- Drop ExcludeArch for IBM Z to allow building there for COSMIC

* Thu Aug 21 2025 Cristian Le <git@lecris.dev> - 1.94.5-3
- Convert STI tests to TMT (rhbz#2382901)

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Apr 09 2025 Kate Hsuan <hpa@redhat.com> - 1.94.5-1
- UPdate to the upstream version 1.94.5

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Thu Nov 21 2024 Kate Hsuan <hpa@redhat.com> - 1.94.4-1
- Update to the upstream release 1.94.4

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.2-12
